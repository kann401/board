...
// [이전] blockBegin 42 43 44 45 46 47 48 49 blockEnd [다음]
	...
	public Pager(int count, int curPage) {	//처음 게시판을 들어가면 (1000, 1)값이 들어간다.
	...
	//페이지 블록의 갯수 계산 ( 총100페이지라면 10개 블록)
	...
	public String toString() {
		return "Pager [curPage=" + curPage + ", prevPage=" + prevPage + ", nextPage=" + nextPage + ", totPage="
				+ totPage + ", curBlock=" + curBlock + ", prevBlock=" + prevBlock + ", nextBlock=" + nextBlock
				+ ", totBlock=" + totBlock + ", pageBegin=" + pageBegin + ", pageEnd=" + pageEnd + ", blockBegin="
